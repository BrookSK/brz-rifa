-- Dados iniciais para o Sistema BRZ Rifa (versão corrigida)
...
-- Inserir usuário administrador padrão (só se não existir)
INSERT IGNORE INTO users (name, email, password_hash, profile) VALUES 
